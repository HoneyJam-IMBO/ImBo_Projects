...
ID3D11ShaderResourceView* CAORenderer::Excute(shared_ptr<CCamera> pCamera, CBlur* pQuadBlur) {
	if (m_bSSAOOnOff) {
		...
		m_pd3dsrvAmbientOcculution = pQuadBlur->Excute(m_pd3dsrvAmbientOcculution);
	}
